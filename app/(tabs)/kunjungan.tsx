        ...
        return (
          <View style={styles.roleContent}>
            ...
            >
              ...
              <Text style={[styles.cardContent, { color: theme.icon }]}>
                Kamis, 20 Juli 2023 - 09:00 WIB
              </Text>
              <Text style={[styles.cardStatus, { color: theme.tint }]}>
                Belum Diverifikasi
              </Text>
            </View>
          </View>
      ...
      case "dosen":
        return (
          <View style={styles.roleContent}>
            ...
            >
              <Text style={[styles.cardTitle, { color: theme.text }]}>
                Kunjungan Mahasiswa Bimbingan
              </Text>
              <Text style={[styles.cardContent, { color: theme.text }]}>
                Ahmad Rizki - 190511001
              </Text>
              <Text style={[styles.cardContent, { color: theme.icon }]}>
                PT. Teknologi Indonesia
              </Text>
              ...
              <Text style={[styles.cardStatus, { color: "#f59e0b" }]}>
                Menunggu Verifikasi
              </Text>
            </View>
          </View>
